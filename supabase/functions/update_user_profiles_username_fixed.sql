-- Function to update user_profiles username from auth.users metadata with duplicate handling
...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE 'Updated username for user %: %', user_record.id, final_username;
    END LOOP;
END;
$$;
